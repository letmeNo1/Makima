...
class BRISK:
    ...
    def pic_match(self):
        ...
        keypoints1, descriptors1 = brisk.detectAndCompute(target_image, None)
        keypoints2, descriptors2 = brisk.detectAndCompute(matching_image, None)
